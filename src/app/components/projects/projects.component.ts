...
export class ProjectsComponent {
  projects: Project[] = [
        { name: 'MindsBridge', description: 'MindsBridge is a platform built to aid learning support and psychiatrist help regardless of the situation.A key feature to boost education systems in Kenya', tools: ['Angular','Bootstrap','Render(rendering)'], year: 2025, link: 'https://mind-bridge.co.ke/' },
